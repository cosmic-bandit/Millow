...
function App() {
  ...
  if (showSettings && config) {
    return (
      <div className="window" onKeyDown={(e) => { const tag = (e.target as HTMLElement).tagName; if (tag !== "INPUT" && tag !== "TEXTAREA" && tag !== "SELECT") e.preventDefault(); }} onKeyUp={(e) => { const tag = (e.target as HTMLElement).tagName; if (tag !== "INPUT" && tag !== "TEXTAREA" && tag !== "SELECT") e.preventDefault(); }}>
